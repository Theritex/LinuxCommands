...
| apt dist-upgrade | Versión más avanzada de `upgrade`. Además de realizar una actualización completa, también maneja cambios de dependencias de forma inteligente, pudiendo instalar paquetes nuevos o eliminar los obsoletos
